...
namespace SV20T1020362.DataLayers
{
    ...
    public interface ICommonDAL<T> where T : class
    {
        ...
        /// <summary>
        /// Bổ sung dữ liệu vào cơ sở dữ liệu . Hàm trả về ID của dữ liệu được bổ sung (trả về giá trị 0 nếu việc bổ sung không thành công ) 
        /// </summary>
        ...
        T? Get(int id);
        /// <summary>
        /// Kiểm tra bản ghi dữ liệu có mã id hiện đang có được sử dụng bởi 
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        bool IsUsed (int id);
