...
namespace SV20T1020362.BusinessLayers
{
    public static class OrderDataService
    {
        ...
        /// <summary>
        /// Khởi tạo 1 đơn hàng mới (tạo đơn hàng mới ơ trạng thái Init):
        ...
        /// <summary>
        /// Lưu thông tin chi tiết của đơn hàng (têm mặt hàng được bán trong đơn hàng)
        /// - Nếu mặt hàng chưa có trong chi tiết đơn hàng thì bỏ sung
        ...
        public static bool UpdateDeliveryOrder(int orderID, string deliveryAddress, string deliveryProvince)
        {
            Order? data = orderDB.Get(orderID);
            if (data == null)
                return false;
            return orderDB.UpdateDelivery(orderID, deliveryAddress, deliveryProvince);
